...
| C3 | **No Heavy Abstractions** | Avoid speculative wrappers or ORMs. Databases are supported directly via SQLite (`bun:sql`) and MySQL. Do not add complex dynamic query generator patterns. |
